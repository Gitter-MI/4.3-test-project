...
func _on_timer_timeout() -> void:
    ...
    navigation_controller._on_navigation_command("AI_SPRITE", random_floor, -1, "player_input", new_position)
...
func instantiate_sprite():
    add_to_group("ai_sprite")   # for other nodes explicitly referencing this player sprite
